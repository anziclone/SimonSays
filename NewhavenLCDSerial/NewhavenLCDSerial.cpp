/*
  NewhavenLCDSerial.cpp - Library for controlling a Newhaven Serial LCD module with RS-232 via Software Serial
...
NewhavenLCDSerial::NewhavenLCDSerial(int pin) : SoftwareSerial(pin, pin){
	pinMode(pin, OUTPUT);
	begin(9600);
	_numlines = LCD_2LINE;
